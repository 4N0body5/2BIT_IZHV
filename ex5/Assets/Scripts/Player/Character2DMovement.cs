...
public class Character2DMovement : MonoBehaviour
{
    ...
    void AnimateCharacter()
    {
		...
		if (mHeadingRight == false && transform.localRotation.y != 1)
			transform.localRotation *= Quaternion.Euler(0, -180f , 0);
		else if (mHeadingRight == true && transform.localRotation.y != 0)
			transform.localRotation *= Quaternion.Euler(0, 180f, 0);
		...
		*/
	    ...
	    if (animator != null)
	    {
			...
			/* // prv som si nevsimla predpripravene premenne xD
			if (mInput.jump == true)
			{
